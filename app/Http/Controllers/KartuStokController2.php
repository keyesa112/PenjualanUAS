...
class KartuStokController2 extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('penjualan-kasir.kartustok.index', compact('kartustok'));
    }
    ...
    public function create()
    {
        ...
        return view('penjualan-kasir.kartustok.create', compact('barangs'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('kartustok-kasir')->with('status', 'Kartu stok berhasil ditambahkan!');
    }
    ...
    public function show(string $idkartu_stok)
    {
        ...
        // return $users;
        return view('penjualan-kasir.kartustok.show', compact('kartustok'));
    }
    ...
    public function edit(string $idkartu_stok)
    {
        $barangs = DB::select('SELECT *
            FROM barang');// Mengambil semua peran dari tabel vendor
        $kartustok = DB::table('kartu_stok')->where('idkartu_stok', $idkartu_stok)->first();
        return view('penjualan-kasir.kartustok.edit', compact('barangs','kartustok'));
    }
    ...
    public function update(Request $request, string $idkartu_stok)
    {
        ...
        return redirect('kartustok-kasir')->with('status', 'Kartu stok berhasil diubah!');
    }
